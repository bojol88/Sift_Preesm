...
char *const FIFO_Head_Render_end_g__Writ__0 = (char*) (SharedMem+28232284);  // FIFO_Head_Render_end_g > WritePGM_init_g size:= 101376*char
char *const FIFO_Head_Init_end_sigmas__s__0 = (char*) (SharedMem+43249432);  // FIFO_Head_Init_end_sigmas > sigmas_init_in size:= 144*char
sem_t sem_11_SSRE;
sem_t sem_12_SSRE;
sem_t sem_13_SSRE;
...
void *computationThread_Core1(void *arg){
	...
	while(1){
		...
		receiveStart(); // Core0 > Core1: WritePGM_init_b__WritePGM__0 
		receiveEnd(&sem_2_SSRE/*ID*/); // Core0 > Core1: WritePGM_init_b__WritePGM__0 
		...
		sendStart(&sem_11_SSRE/*ID*/); // Core1 > Core3: sigmas__sigmas_end_out3__0 
		sendEnd(); // Core1 > Core3: sigmas__sigmas_end_out3__0 
		sendStart(&sem_12_SSRE/*ID*/); // Core1 > Core2: sigmas__Orientation__0 
		sendEnd(); // Core1 > Core2: sigmas__Orientation__0 
		sendStart(&sem_13_SSRE/*ID*/); // Core1 > Core2: sigmas__BuildSS__0 
		sendEnd(); // Core1 > Core2: sigmas__BuildSS__0 
