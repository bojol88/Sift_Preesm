...
pointList *const keyPointList__keyPointList__0 = (pointList*) (SharedMem+42494160);  // Extreme_keyPointList > Orientation_keyPointList size:= 1*pointList
...
pointList *const keyPointListCP__keyPointList__0 = (pointList*) (SharedMem+42278088);  // Orientation_keyPointListCP > Render_keyPointList size:= 1*pointList
...
void *computationThread_Core0(void *arg){
	...
	while(1){
		...
		receiveStart(); // Core1 > Core0: octavesH__Render__0 
		receiveEnd(&sem_2_SSRE/*ID*/); // Core1 > Core0: octavesH__Render__0 
		receiveStart(); // Core1 > Core0: octavesH__Extreme__0 
		receiveEnd(&sem_3_SSRE/*ID*/); // Core1 > Core0: octavesH__Extreme__0 
		receiveStart(); // Core1 > Core0: octavesH__DoG__0 
		receiveEnd(&sem_4_SSRE/*ID*/); // Core1 > Core0: octavesH__DoG__0 
		receiveStart(); // Core1 > Core0: octavesH__BuildSS__0 
		receiveEnd(&sem_5_SSRE/*ID*/); // Core1 > Core0: octavesH__BuildSS__0 
		receiveStart(); // Core1 > Core0: octavesH__BuildOB__0 
		receiveEnd(&sem_6_SSRE/*ID*/); // Core1 > Core0: octavesH__BuildOB__0 
		receiveStart(); // Core3 > Core0: octavesW__Render__0 
		receiveEnd(&sem_7_SSRE/*ID*/); // Core3 > Core0: octavesW__Render__0 
		receiveStart(); // Core3 > Core0: octavesW__Orientation__0 
		receiveEnd(&sem_8_SSRE/*ID*/); // Core3 > Core0: octavesW__Orientation__0 
		receiveStart(); // Core3 > Core0: octavesW__Extreme__0 
		receiveEnd(&sem_9_SSRE/*ID*/); // Core3 > Core0: octavesW__Extreme__0 
		receiveStart(); // Core3 > Core0: octavesW__DoG__0 
		receiveEnd(&sem_10_SSRE/*ID*/); // Core3 > Core0: octavesW__DoG__0 
		receiveStart(); // Core3 > Core0: octavesW__BuildSS__0 
		receiveEnd(&sem_11_SSRE/*ID*/); // Core3 > Core0: octavesW__BuildSS__0 
		receiveStart(); // Core3 > Core0: octavesW__BuildOB__0 
		receiveEnd(&sem_12_SSRE/*ID*/); // Core3 > Core0: octavesW__BuildOB__0 
		receiveStart(); // Core2 > Core0: sigmas__Render__0 
		receiveEnd(&sem_13_SSRE/*ID*/); // Core2 > Core0: sigmas__Render__0 
		receiveStart(); // Core2 > Core0: sigmas__Orientation__0 
		receiveEnd(&sem_14_SSRE/*ID*/); // Core2 > Core0: sigmas__Orientation__0 
		receiveStart(); // Core2 > Core0: sigmas__BuildSS__0 
		receiveEnd(&sem_15_SSRE/*ID*/); // Core2 > Core0: sigmas__BuildSS__0 
		// Broadcast Img
		{
